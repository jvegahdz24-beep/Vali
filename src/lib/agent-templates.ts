...
export const agentTemplates: AgentTemplate[] = [
  ...
  {
    id: 'tpl-agent-9',
    name: 'EXPERTO — Educador y Constructor de Valor',
    description: 'Módulo 2 del Revenue Engine. Activa cuando el lead necesita información técnica, simulaciones de crédito o cotizaciones. Construye valor antes del cierre.',
    type: 'sales',
    personality: 'EXPERTO',
    model: 'glm',
    modelName: 'glm-4.5-flash',
  ...
  {
    id: 'tpl-agent-10',
    name: 'SELLER Pro — Cerrador Transaccional',
    description: 'Módulo 3 del Revenue Engine. Activa con leads score ≥ 60. Ejecuta el cierre con precio + valor + siguiente paso concreto. Solicita RFC, forma de pago y genera la factura.',
    type: 'sales',
    personality: 'SELLER',
    model: 'glm',
    modelName: 'glm-4.5-flash',
  ...
  {
    id: 'tpl-agent-11',
    name: 'SERVICIO — Postventa y Fidelización',
    description: 'Módulo 4 del Revenue Engine. Activa cuando el deal está Cerrado Ganado. Garantiza satisfacción, resuelve dudas de implementación y activa el programa de referidos.',
    type: 'followup',
    personality: 'SERVICIO',
    model: 'glm',
    modelName: 'glm-4.5-flash',
    temperature: 0.6,
    maxTokens: 4096,
