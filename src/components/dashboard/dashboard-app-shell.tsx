...
// ═══════════════════════════════════════════════════════════════
// ValiAutoFlow — Dashboard App Shell (client-side only)
// Loaded with ssr:false from page.tsx to prevent standalone OOM
// Contains ALL dashboard logic: auth check, workspace init, routing
// ═══════════════════════════════════════════════════════════════
...
// ─── Lazy-loaded views (client-side only) ───────────────────
